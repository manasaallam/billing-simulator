 ...
 *
 * Two usage modes:
 * 1. Initial query:        customerId + naturalLanguageQuery (AI extracts params)
 * 2. Clarification reply:  customerId + conversationId + extractedParameters (user provided missing info)
 *
 * Example (initial):
 *   POST /api/simulate
 *   { "customerId": "CUST-001", "naturalLanguageQuery": "What if I shift 30% of Air to Ground?" }
 *
 * Example (clarification):
 *   POST /api/simulate/clarify
 *   { "customerId": "CUST-001", "conversationId": "abc-123", "extractedParameters": { ... } }
 */
