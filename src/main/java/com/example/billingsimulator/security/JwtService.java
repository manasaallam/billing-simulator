package com.example.billingsimulator.security;
...
/**
 * Issues and validates stateless HS256 JWT session tokens.
 * The signing secret and expiry are configured via {@code app.jwt.*} properties.
 */
@Service
